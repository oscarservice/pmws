...
<html>
    <head>
        ...
        <title>@yield('title') | THT Token</title>
    ...
    <body>
            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li><h1 class="logo-wrapper"><a href="{{ route('dashboard') }}" class="brand-logo darken-1"><img src="{{ asset('assets/images/jltoken-logo.png') }}" alt="materialize logo"></a><span class="logo-text">THT Token</span></h1></li>
                        </ul>
        ...
        <footer class="page-footer">
            <div class="footer-copyright">
                <div class="container">
                    <span>Powered by <a class="grey-text text-lighten-3" href="http://www.thealthtech.com" target="_blank">Thrinity Health Technologies</a> All rights reserved.</span>
