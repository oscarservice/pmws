...
<html>
    <head>
        ...
        <title>Forgot Password | THT Token</title>
    ...
    <body class="teal">
        ...
        <div id="login-page" class="row">
            ...
            <div class="row center-align white-text" style="margin-bottom:0">
                <span>Powered by <a href="http://www.thealthtech.com" target="_blank" style="color:#ccc">Thrinity Health Technologies</a></span>
            </div>
        </div>
